...
import NavigationLinks from './navigation-links.gjs';
import Facebook from './svg-icons/facebook.gjs';
import Twitter from './svg-icons/twitter.gjs';
import Rss from './svg-icons/rss.gjs';
